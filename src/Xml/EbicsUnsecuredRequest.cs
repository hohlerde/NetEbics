...
{
    internal class EbicsUnsecuredRequest : NamespaceAware, IXDocumentSerializer
    {
        ...
        public XDocument Serialize()
        {
            ...
            return new XDocument(
                new XElement(nsEbics + XmlNames.ebicsUnsecuredRequest,
                    new XAttribute(XmlNames.Version, Version.ToString()),
                    new XAttribute(XmlNames.Revision,
                        Revision.ToString().TrimStart("Rev".ToCharArray())),
